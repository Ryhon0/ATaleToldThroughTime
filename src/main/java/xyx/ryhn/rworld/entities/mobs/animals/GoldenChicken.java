package xyx.ryhn.rworld.entities.mobs.animals;
...
public class GoldenChicken extends ChickenEntity {
	...
	public static class Renderer extends ChickenEntityRenderer {
		...
		private static final Identifier TEXTURE = RWorld.Key("textures/entity/golden_chicken.png");
