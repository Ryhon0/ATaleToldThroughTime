...
public class MendingTransferItem extends Item {
	...
	public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
		...
		tooltip.add(Text.translatable(armor ? "item.rworld.mending_plate.lore" : "item.rworld.mending_cloth.lore"));
		tooltip.add(Text.translatable("item.rworld.mending_effect_lore"));
	}
