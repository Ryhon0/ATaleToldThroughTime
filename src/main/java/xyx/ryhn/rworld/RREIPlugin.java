...
public class RREIPlugin implements REIClientPlugin {
	...
	public static class Category implements DisplayCategory<BasicDisplay> {
		public static final Identifier TEXTURE = RWorld.Key("textures/gui/cauldron_gui.png");
		public static final CategoryIdentifier<Display> DISPLAY = CategoryIdentifier.of(RWorld.Key("cauldron"));
		@Override
		...
		public Text getTitle() {
			return Text.translatable("gui.rworld.rei.category");
		}
