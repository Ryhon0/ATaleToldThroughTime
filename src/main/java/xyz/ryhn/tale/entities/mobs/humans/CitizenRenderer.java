package xyz.ryhn.tale.entities.mobs.humans;
...
public class CitizenRenderer extends MobEntityRenderer<Citizen, CitizenRenderer.Model> {
	public static final EntityModelLayer CITIZEN_LAYER = new EntityModelLayer(Main.Key("citizen"), "main");
	...
	public Identifier getTexture(Citizen entity) {
		return Main.Key("textures/entity/citizen/citizen.png");
	}
